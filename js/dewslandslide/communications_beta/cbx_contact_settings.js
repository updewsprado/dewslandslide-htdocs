...
function addNewMobileForCommunity () {
	...
	$("#community-add-landline").click(function(){
		if (community_input_count_landline <= 4) {
			...
			"<input type='number' class='form-control community_landline_number' id='community_landline_number_"+community_input_count_landline+"'' name='community_landline_number' value='' required>"+
			"</div>"+
			"<div class='col-md-4' hidden>"+
			"<label>Landline ID #:</label>"+
			"<input type='text' id='community_landline_id_"+community_input_count_landline+"'' class='form-control community_landline_id' value='' disabled>"+
			"</div>"+
			"<div class='col-md-6'>"+
			"<label>Remarks:</label>"+
			"<input type='text' class='form-control community_landline_number' id='community_landline_remarks_"+community_input_count_landline+"'' name='community_landline_remarks' value='' required>"+
			"</div>"+
			"</div>");
